...
//            └─────┴─────┘                       └─────┴─────┘
[_LOWER] = LAYOUT(
 KC_TILD , KC_EXLM , KC_AT   , KC_HASH , KC_DLR  ,                         KC_CIRC , KC_AMPR , KC_ASTR , KC_LPRN , KC_RPRN ,
...
//    │     │     │     │         │         │     │               │         │         │   i   │         │ sCRL │ mute │
//    ├─────┼─────┼─────┼─────────┼─────────┼─────┤               ├─────────┼─────────┼───────┼─────────┼──────┼──────┤
//    │     │     │     │ MS_BTN2 │ MS_BTN1 │     │               │  left   │  down   │  up   │  rght   │      │ volu │
//    ├─────┼─────┼─────┼─────────┼─────────┼─────┤               ├─────────┼─────────┼───────┼─────────┼──────┼──────┤
//    │     │     │     │         │         │     │               │ MS_LEFT │ MS_DOWN │ MS_UP │ MS_RGHT │      │ vold │
//    └─────┴─────┼─────┼─────────┼─────────┴─────┘               └─────────┴─────────┼───────┼─────────┼──────┴──────┘
//                │     │         │                                                   │       │         │
//                └─────┴─────────┼─────────┬─────┐               ┌─────────┬─────────┼───────┴─────────┘
//                                │         │     │               │         │         │
...
//   _______ , _______ , _______ , _______ , _______ , _______ ,                         _______ , _______ , KC_I    , _______  , KC_SCRL , KC_MUTE,
//   _______ , _______ , _______ , MS_BTN2 , MS_BTN1 , _______ ,                         KC_LEFT , KC_DOWN , KC_UP   , KC_RIGHT , _______ , KC_VOLU,
//   _______ , _______ , _______ , _______ , _______ , _______ ,                         MS_LEFT , MS_DOWN , MS_UP   , MS_RGHT  , _______ , KC_VOLD,
//                       _______ , _______ ,                                                                 _______ , _______                     ,
//                                           _______ , _______ ,                         _______ , _______                                         ,
//                                                     _______ , _______ ,     _______ , _______                                                   ,
//                                                     _______ , _______ ,     _______ , _______
